...
PARAMS_STR = ["LABEL"]
PARAMS_BOOL = ["COMBINE_DELIVERY_PICKUP_TOUR", "CROWDSHIPPING", "CONSOLIDATED_TRIPS"]
PARAMS_NUM = ["PARCELS_MAXLOAD", "PARCELS_DROPTIME",
              "PARCELS_MAXLOAD_Hub2Hub", "PARCELS_DROPTIME_Hub2Hub"]
PARAMS_LIST_STR = ["Gemeenten_studyarea", "Gemeenten_CS"]
PARAMS_LIST_BOOL = []
PARAMS_LIST_NUM = []
PARAMS_JSON = []

logger = getLogger("parceltourformation.envctl")
