...
logger = logging.getLogger("parceltourformation")
...
def main():
    ...
    parser.add_argument('PARCELS_HUB2HUB', type=strfile,
                        help='The path of the demand parcel fulfilment file (csv)')
    ...
    parser.add_argument('DEPARTURE_TIME_PARCELS_CDF', type=strfile,
                        help='The path of the departure time parcels CDF file (csv)')
    parser.add_argument('SUP_COORDINATES', type=strfile,
