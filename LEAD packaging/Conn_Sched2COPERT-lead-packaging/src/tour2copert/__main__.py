...
DESC = """
Parcel Tour Formation To COPERT and EV connector.
...
logger = logging.getLogger("parceltour2copert")
...
def main():
    ...
    parser.add_argument('parcel_activity', type=strfile,
                        help='The output of the Parcel Tour Formation model (csv)')
    parser.add_argument('weather', type=strfile,
                        help='The path of weather file (csv)')
