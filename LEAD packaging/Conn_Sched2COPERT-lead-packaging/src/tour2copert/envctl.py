"""An environment variables controller module
"""
...
PARAMS_STR = []
PARAMS_BOOL = ["ElectricEmissions"]
PARAMS_NUM = ["PeakHourMorningStart", "PeakHourMorningFinish",
              "PeakHourAfternoonStart", "PeakHourAfternoonFinish",
              "Year"]
PARAMS_LIST_STR = []
PARAMS_LIST_BOOL = []
PARAMS_LIST_NUM = []
PARAMS_JSON = ["VehicleType", "VehicleEuroStand", "VehicleCat", "VehicleFuel", "VehicleSegment",
               "VehicleOffPeakSpeed", "VehiclePeakSpeed"]

logger = getLogger("parceltour2copert.envctl")
