...
def actually_run_module(args):
    ...
    try:
        ...
        dimVT = pd.read_csv(
            ...
            sep='\t')
        dimET = pd.read_csv(
            varDict['INPUTFOLDER'] + 'emission_type.txt',
            sep='\t')
        ...
        vanTripsConstruction = read_mtx(
            varDict['INPUTFOLDER'] + 'TripsVanConstruction.mtx')
        ...
        for tod in range(nHours):
            tripMatricesParcelsTOD.append(pd.read_csv(
                varDict['INPUTFOLDER'] + "tripmatrix_parcels_" + str(varDict['LABEL']) + "_TOD" + str(tod) + ".txt",
                sep='\t'))
        ...
        try:
            ...
            toursPath_w = (
                varDict['OUTPUTFOLDER'] +
                'Tours_' + varDict['LABEL'] + '_Emission' + '.csv')
            parcelToursPath_w = (
                varDict['OUTPUTFOLDER'] +
                'ParcelSchedule_' + varDict['LABEL'] + '_Emission' + '.csv')
            shipmentsPath_w = (
                varDict['OUTPUTFOLDER'] +
